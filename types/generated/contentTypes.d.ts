...
export interface ApiClassementClassement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DifferenceButs: Schema.Attribute.Integer & Schema.Attribute.Required;
    Gagnes: Schema.Attribute.Integer & Schema.Attribute.Required;
    Joues: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    NomEquipe: Schema.Attribute.String & Schema.Attribute.Required;
    Nuls: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DateMatch: Schema.Attribute.Date & Schema.Attribute.Required;
    EquipeDomicile: Schema.Attribute.String & Schema.Attribute.Required;
    EquipeExterieur: Schema.Attribute.String;
    EstJoue: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    HeureMatch: Schema.Attribute.Time & Schema.Attribute.Required;
    ImageMatch: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    ScoreExterieur: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
